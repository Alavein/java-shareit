...
public class BookingController {
    ...
    public ResponseEntity<Object> getAllBookingOfUser(@RequestParam(name = "state", defaultValue = "ALL") String stateParam,
        ...
        BookingStatusPresentation state = BookingStatusPresentation.from(stateParam)
    ...
    @PostMapping
    public ResponseEntity<Object> addBookingRequest(@Validated(Create.class) @RequestBody BookItemRequestDto requestDto,
                                                    @RequestHeader("X-Sharer-User-Id") Integer userId) {
