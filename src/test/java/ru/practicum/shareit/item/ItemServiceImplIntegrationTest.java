...
class ItemServiceImplIntegrationTest {
    ...
    void beforeEach() {
        ...
        item = new Item(null, "Предмет", "Описание", true, user,
                null);
        item = itemRepository.save(item);
        itemId = item.getId();

        comment = new Comment(null, "Комментарий", item, user, LocalDateTime.now());
